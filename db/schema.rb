...
ActiveRecord::Schema.define(version: 20180213144338) do
  ...
  create_table "dishes", force: :cascade do |t|
    ...
    t.index ["saved_restaurant_id"], name: "index_dishes_on_saved_restaurant_id"
  end
  ...
  add_foreign_key "dishes", "saved_restaurants"
